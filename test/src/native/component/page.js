...
import { eventProccesser } from '../utils/event';
	...
	options: {
		...
		methods: {
			...
			eventHappen: function(eventName, $event, reflectMethod, capture, catchType, customEventParams) {
				...
				console.log('mock eventHappen sendMaster', data)
				window.testutils.clientActions.sendMasterMessage(data);
			...
			initMessagebinding: function() {
				window.swanInterface.communicator.onMessage(
